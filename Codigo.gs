...
var CFG_DEFAULTS = [
  ['Artista', 'Maury'],
  ['Cliente (valor en base central)', 'MAURY'],
  ...
  ['Secreto del webhook Samply', 'maury33'],
  ['Propiedad % del artista en Notion', '% Maury'],
  ['Equipo (Nombre:código:estado en Notion)', 'Sofía:1234:🧑 Tareas de Sofía, Pepe:1111:👤 Tareas de Pepe, Isis:5678:👩 Tareas de Isis'],
